...
Codebook.Rmd- automated codebook whch use as an inut tidydataset.txt file from step5
Coodbook_for_run_analysisl.html - file generated by knit of the output of Codebook.Rmd
Readme.md - this file 
run_analysis.R -code for running analysis
----------------------------------------------------------------------------------------------
