...
1. Coodebook.md- automated codebook whch uses as an imput for this project the tidydataset.txt file from step5,
(needs to be renamed to Coodebook.Rmd to run it in R-Studio) I belive, it could use any other imput appropriate.
